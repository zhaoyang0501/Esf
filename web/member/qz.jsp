...
<TBODY><!-- 户型 视频 面积 价格 电话 联系人  地址 介绍 发布时间 -->
    ...
    <%	List pagelist3=hsb.getAllInw(username);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(8).toString()%></td>
         <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>HouseServlet?method=delInowner&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
  </tr>
