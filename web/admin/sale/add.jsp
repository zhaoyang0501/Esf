...
<%
	...
	if(method.equals("upSale")){
		...
		qy=list.get(11)==null?"":list.get(11).toString();
		xq=list.get(10)==null?"":list.get(10).toString();
		   ...
		   <TR  align="center" bgColor=#ffffff>
			...
			<TD align=left>
				<select name="zt" value='<%=zt %>'>
					...
					<option value="可售" <%= "可售".equals(zt)?"selected='selected'":"" %> >可售</option>
					<option value="已付定金"  <%= "已付定金".equals(zt)?"selected='selected'":"" %> >已付定金</option>
					<option value="已售"  <%= "已售".equals(zt)?"selected='selected'":"" %>>已售</option>
				</select>
			 </TD>
		  </TR>
		    <TR  align="center" bgColor=#ffffff>
